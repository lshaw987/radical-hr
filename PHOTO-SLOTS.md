# Photo slots - the photos the site still needs

Added 2026-09-13 at Lisa's ask ("put in placeholders and I'll help you find them").
Every slot renders as a dashed lilac "Photo to come" box. **All must be filled or removed before go-live** - search the source for `<PhotoSlot`.
Rules: real photos only (Lisa's image guidelines in the Radical HR design language), rounded corners never circular, identifiable client faces only with written OK.

| # | Page | What the photo should show |
|---|---|---|
| 1 | Home - under the stakes block | FILLED 13 Sept: facilitate-sticky-notes.jpg (Unsplash, kvalifik) |
...
All 10 slots filled 13 Sept. Unsplash photos: free licence, credit optional (kvalifik, Gilles Roux). Source of the filled ones: `Radical HR All - Images` (SharePoint-synced, cloud-only) picks 30/31/37/39/40/41.
